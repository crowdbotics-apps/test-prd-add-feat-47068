"""
Django settings for test_prd_add_feat_47068 project.
...
ROOT_URLCONF = 'test_prd_add_feat_47068.urls'
...
WSGI_APPLICATION = 'test_prd_add_feat_47068.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_add_feat_47068 API",
    "DESCRIPTION": "API documentation for test_prd_add_feat_47068 App",
    "VERSION": "v1",
}
